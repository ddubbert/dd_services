...
export default gql`
  ...
  type Mutation {
    createOrLoginUser: UserAndAuthenticationDetails! @rateLimit(limit: 1000, duration: 60)
    refreshAuth(token: String!): AuthenticationDetails!
    deleteUser(userId: String!): DeletionResponse! @rateLimit(limit: 150, duration: 60)
  }
